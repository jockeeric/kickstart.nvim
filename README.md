...
```sh
# on Linux and Mac
git clone git@github.com:jockeeric/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows (cmd)
git clone git@github.com:jockeeric/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```

```
# on Windows (powershell)
git clone git@github.com:jockeeric/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
